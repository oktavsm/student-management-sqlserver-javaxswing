 ...
 * Click nbfs:
 */
package App.CRUDFolder.mahasiswa;
...
public class MahasiswaPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        insertPanelLayout.setHorizontalGroup(
            ...
            .addGroup(insertPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(insertGenderComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)) 
        );
        insertPanelLayout.setVerticalGroup(
            ...
            .addGroup(insertPanelLayout.createSequentialGroup()
                .addGroup(insertPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(insertGenderComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)) 
        ...
        modelCombo = new DefaultComboBoxModel<ComboItem>(); 
        ...
        updatePanelLayout.setHorizontalGroup(
            ...
            .addGroup(updatePanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(updateGenderComboBox, 0, 180, Short.MAX_VALUE)) 
        ...
        updatePanelLayout.setVerticalGroup(
            ...
            .addGroup(updatePanelLayout.createSequentialGroup()
                .addGroup(updatePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(updateGenderComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE) 
        ...
        studentNIMComboBox1.setModel(modelCombo); 
            ...
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                if (evt.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    if (selectedItem != null) {
                        ...
                        removeGenderComboBox.setEnabled(false); 
                    }
                }
            }
        });
        ...
        removePanelLayout.setHorizontalGroup(
            ...
            .addGroup(removePanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(removeGenderComboBox, 0, 182, Short.MAX_VALUE)) 
        ...
        removePanelLayout.setVerticalGroup(
            ...
            .addGroup(removePanelLayout.createSequentialGroup()
                .addGroup(removePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(removeGenderComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE) 
        ...
        studentTable.setPreferredSize(new java.awt.Dimension(150, 607)); 
        studentTable.setSelectionForeground(new java.awt.Color(153, 153, 153)); 
    ...
    private void insertNIMFieldActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void insertStudentNameFieldActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    void setUpdate() {
        ...
        if (studentNIMComboBox.getItemCount() > 0) {
             studentNIMComboBox.setSelectedIndex(0); 
    ...
    void setRemove() {
        ...
        cl.show(crudPanel, "removeCard");
         if (studentNIMComboBox1.getItemCount() > 0) {
            studentNIMComboBox1.setSelectedIndex(0); 
            ComboItem selectedItem = (ComboItem) studentNIMComboBox1.getSelectedItem();
            if (selectedItem != null) {
                studentNameField1.setText(selectedItem.getValue());
                removeGenderComboBox.setSelectedItem(selectedItem.getValue1());
    ...
    void loadTable() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                modelCombo.addElement(new ComboItem(nim, nama, genderDisplay)); 
            }
            rs.close();
            stmt.close();
    ...
    void insert(String nim, String name, String genderDB) { 
    ...
    void update(String nim, String name, String genderDB) { 
    ...
    private javax.swing.JComboBox<App.ComboItem> studentNIMComboBox;
    private javax.swing.JComboBox<App.ComboItem> studentNIMComboBox1;
